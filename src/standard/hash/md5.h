#ifndef bird_module_hash_hash_h
#define bird_module_hash_hash_h
...
/* b_md5_ptr defines a generic pointer type */
typedef unsigned char *b_md5_ptr;
...
static void MD5_memset(b_md5_ptr, int, unsigned int);
...
void MD5Update(MD5_CTX *context, unsigned char *input, unsigned int inputLen) {
  ...
  if (inputLen >= partLen) {
    MD5_memcpy
        ((b_md5_ptr) &context->buffer[index], (b_md5_ptr) input, partLen);
  ...
  MD5_memcpy
      ((b_md5_ptr) &context->buffer[index], (b_md5_ptr) &input[i],
       inputLen - i);
}
...
static void MD5Transform(uint32_t state[4], unsigned char block[64]) {
  ...
  /* Zeroize sensitive information. */
  MD5_memset((b_md5_ptr) x, 0, sizeof(x));
}
 ...
 */
static void MD5_memcpy(b_md5_ptr output, b_md5_ptr input, unsigned int len) {
  unsigned int i;
 ...
 */
static void MD5_memset(b_md5_ptr output, int value, unsigned int len) {
  unsigned int i;
...
static char *MD5File(char *filename) {
  FILE *file;
  MD5_CTX context;
