...
static int parse_declarations(b_vm *vm, int sym);
static int parse_declaration_specifiers(b_vm *vm, int sym, clib_ffi_dcl *dcl);
static int parse_specifier_qualifier_list(b_vm *vm, int sym, clib_ffi_dcl *dcl);
static int parse_type_qualifier_list(b_vm *vm, int sym, clib_ffi_dcl *dcl);
static int parse_type_qualifier(int sym, clib_ffi_dcl *dcl);
static int parse_type_specifier(b_vm *vm, int sym, clib_ffi_dcl *dcl);
static int parse_struct_or_union_specifier(b_vm *vm, int sym, clib_ffi_dcl *dcl);
static int parse_struct_contents(b_vm *vm, int sym, clib_ffi_dcl *dcl);
static int parse_struct_declaration(b_vm *vm, int sym, clib_ffi_dcl *struct_dcl);
static int parse_struct_declarator(b_vm *vm, int sym, clib_ffi_dcl *struct_dcl, clib_ffi_dcl *field_dcl);
static int parse_enum_specifier(b_vm *vm, int sym, clib_ffi_dcl *dcl);
static int parse_enumerator_list(b_vm *vm, int sym, clib_ffi_dcl *enum_dcl);
static int parse_enumerator(b_vm *vm, int sym, clib_ffi_dcl *enum_dcl, int64_t *min, int64_t *max, int64_t *last);
static int parse_declarator(b_vm *vm, int sym, clib_ffi_dcl *dcl, const char **name, size_t *name_len);
static int parse_abstract_declarator(b_vm *vm, int sym, clib_ffi_dcl *dcl);
static int parse_parameter_declarator(b_vm *vm, int sym, clib_ffi_dcl *dcl, const char **name, size_t *name_len);
static int parse_pointer(b_vm *vm, int sym, clib_ffi_dcl *dcl);
static int parse_array_or_function_declarators(b_vm *vm, int sym, clib_ffi_dcl *dcl, clib_ffi_dcl *nested_dcl);
static int parse_parameter_declaration(b_vm *vm, int sym, b_obj_dict **args);
static int parse_type_name(b_vm *vm, int sym, clib_ffi_dcl *dcl);
static int parse_attributes(b_vm *vm, int sym, clib_ffi_dcl *dcl);
static int parse_attrib(b_vm *vm, int sym, clib_ffi_dcl *dcl);
static int parse_initializer(b_vm *vm, int sym);
static int parse_designation(b_vm *vm, int sym);
static int parse_expr_list(b_vm *vm, int sym);
static int parse_expression(b_vm *vm, int sym, clib_ffi_val *val);
static int parse_assignment_expression(b_vm *vm, int sym, clib_ffi_val *val);
static int parse_constant_expression(b_vm *vm, int sym, clib_ffi_val *val);
static int parse_conditional_expression(b_vm *vm, int sym, clib_ffi_val *val);
static int parse_logical_or_expression(b_vm *vm, int sym, clib_ffi_val *val);
static int parse_logical_and_expression(b_vm *vm, int sym, clib_ffi_val *val);
static int parse_inclusive_or_expression(b_vm *vm, int sym, clib_ffi_val *val);
static int parse_exclusive_or_expression(b_vm *vm, int sym, clib_ffi_val *val);
static int parse_and_expression(b_vm *vm, int sym, clib_ffi_val *val);
static int parse_equality_expression(b_vm *vm, int sym, clib_ffi_val *val);
static int parse_relational_expression(b_vm *vm, int sym, clib_ffi_val *val);
static int parse_shift_expression(b_vm *vm, int sym, clib_ffi_val *val);
static int parse_additive_expression(b_vm *vm, int sym, clib_ffi_val *val);
static int parse_multiplicative_expression(b_vm *vm, int sym, clib_ffi_val *val);
static int parse_cast_expression(b_vm *vm, int sym, clib_ffi_val *val);
static int parse_unary_expression(b_vm *vm, int sym, clib_ffi_val *val);
static int parse_ID(int sym, const char **name, size_t *name_len);
static int parse_OCTNUMBER(int sym, clib_ffi_val *val);
static int parse_DECNUMBER(int sym, clib_ffi_val *val);
static int parse_HEXNUMBER(int sym, clib_ffi_val *val);
static int parse_FLOATNUMBER(int sym, clib_ffi_val *val);
static int parse_STRING(int sym, clib_ffi_val *val);
static int parse_CHARACTER(int sym, clib_ffi_val *val);
...
static int check_nested_declarator_start(int sym) {
	...
	sym = get_sym();
	if ((sym == YY_ID) && (!clib_ffi_is_typedef_name((const char*)yy_text, yy_pos - yy_text))) {
		sym = check_ID(sym);
		if (sym == -1) {
			return -1;
		}
...
static int parse_declarations(b_vm *vm, int sym) {
	while (YY_IN_SET(sym, (YY___EXTENSION__,YY_TYPEDEF,YY_EXTERN,YY_STATIC,YY_AUTO,YY_REGISTER,YY_INLINE,YY___INLINE,YY___INLINE__,YY__NORETURN,YY__ALIGNAS,YY___ATTRIBUTE,YY___ATTRIBUTE__,YY___DECLSPEC,YY___CDECL,YY___STDCALL,YY___FASTCALL,YY___THISCALL,YY___VECTORCALL,YY_CONST,YY___CONST,YY___CONST__,YY_RESTRICT,YY___RESTRICT,YY___RESTRICT__,YY_VOLATILE,YY___VOLATILE,YY___VOLATILE__,YY__ATOMIC,YY_VOID,YY_CHAR,YY_SHORT,YY_INT,YY_LONG,YY_FLOAT,YY_DOUBLE,YY_SIGNED,YY_UNSIGNED,YY__BOOL,YY__COMPLEX,YY_COMPLEX,YY___COMPLEX,YY___COMPLEX__,YY_STRUCT,YY_UNION,YY_ENUM,YY_ID), "\202\377\377\377\377\107\360\017\000\000\000\002\000")) {
		clib_ffi_dcl common_dcl = CLIB_FFI_ATTR_INIT;
		if (sym == YY___EXTENSION__) {
			sym = get_sym();
		}
		sym = parse_declaration_specifiers(vm, sym, &common_dcl);
		if (sym == YY__STAR || sym == YY_ID || sym == YY__LPAREN) {
			const char *name;
			size_t name_len;
			clib_ffi_dcl dcl;
			dcl = common_dcl;
			sym = parse_declarator(vm, sym, &dcl, &name, &name_len);
			if (sym == YY___ASM__) {
				clib_ffi_val asm_str;
				sym = get_sym();
				if (sym != YY__LPAREN) {
			...
			if (YY_IN_SET(sym, (YY___ATTRIBUTE,YY___ATTRIBUTE__,YY___DECLSPEC,YY___CDECL,YY___STDCALL,YY___FASTCALL,YY___THISCALL,YY___VECTORCALL), "\000\000\000\000\000\000\360\017\000\000\000\000\000")) {
				sym = parse_attributes(vm, sym, &dcl);
			}
			if (sym == YY__EQUAL) {
				sym = parse_initializer(vm, sym);
			}
			clib_ffi_declare(name, name_len, &dcl);
			while (sym == YY__COMMA) {
				sym = get_sym();
				dcl = common_dcl;
				sym = parse_declarator(vm, sym, &dcl, &name, &name_len);
...
static int parse_declaration_specifiers(b_vm *vm, int sym, clib_ffi_dcl *dcl) {
	do {
		switch (sym) {
			case YY_TYPEDEF:
				if (dcl->flags & CLIB_FFI_DCL_STORAGE_CLASS) yy_error_sym("unexpected", sym);
				sym = get_sym();
				dcl->flags |= CLIB_FFI_DCL_TYPEDEF;
				break;
			case YY_EXTERN:
				if (dcl->flags & CLIB_FFI_DCL_STORAGE_CLASS) yy_error_sym("unexpected", sym);
				sym = get_sym();
				dcl->flags |= CLIB_FFI_DCL_EXTERN;
				break;
			case YY_STATIC:
				if (dcl->flags & CLIB_FFI_DCL_STORAGE_CLASS) yy_error_sym("unexpected", sym);
				sym = get_sym();
				dcl->flags |= CLIB_FFI_DCL_STATIC;
				break;
			case YY_AUTO:
				if (dcl->flags & CLIB_FFI_DCL_STORAGE_CLASS) yy_error_sym("unexpected", sym);
				sym = get_sym();
				dcl->flags |= CLIB_FFI_DCL_AUTO;
				break;
			case YY_REGISTER:
				if (dcl->flags & CLIB_FFI_DCL_STORAGE_CLASS) yy_error_sym("unexpected", sym);
				sym = get_sym();
				dcl->flags |= CLIB_FFI_DCL_REGISTER;
				break;
			case YY_INLINE:
			case YY___INLINE:
			case YY___INLINE__:
				sym = get_sym();
				dcl->flags |= CLIB_FFI_DCL_INLINE;
				break;
			case YY__NORETURN:
				sym = get_sym();
				dcl->flags |= CLIB_FFI_DCL_NO_RETURN;
				break;
			case YY__ALIGNAS:
				sym = get_sym();
				if (sym != YY__LPAREN) {
				...
				if ((YY_IN_SET(sym, (YY___EXTENSION__,YY_VOID,YY_CHAR,YY_SHORT,YY_INT,YY_LONG,YY_FLOAT,YY_DOUBLE,YY_SIGNED,YY_UNSIGNED,YY__BOOL,YY__COMPLEX,YY_COMPLEX,YY___COMPLEX,YY___COMPLEX__,YY_STRUCT,YY_UNION,YY_ENUM,YY_ID,YY_CONST,YY___CONST,YY___CONST__,YY_RESTRICT,YY___RESTRICT,YY___RESTRICT__,YY_VOLATILE,YY___VOLATILE,YY___VOLATILE__,YY__ATOMIC,YY___ATTRIBUTE,YY___ATTRIBUTE__,YY___DECLSPEC,YY___CDECL,YY___STDCALL,YY___FASTCALL,YY___THISCALL,YY___VECTORCALL), "\002\000\376\377\377\107\360\017\000\000\000\002\000")) && synpred_1(sym)) {
					clib_ffi_dcl align_dcl = CLIB_FFI_ATTR_INIT;
					sym = parse_type_name(vm, sym, &align_dcl);
					clib_ffi_align_as_type(dcl, &align_dcl);
					...
					clib_ffi_val align_val;
					sym = parse_constant_expression(vm, sym, &align_val);
					clib_ffi_align_as_val(dcl, &align_val);
				} else {
...
static int parse_type_specifier(b_vm *vm, int sym, clib_ffi_dcl *dcl) {
	...
	switch (sym) {
		case YY_VOID:
			if (dcl->flags & CLIB_FFI_DCL_TYPE_SPECIFIERS) yy_error_sym("unexpected", sym);
			sym = get_sym();
			dcl->flags |= CLIB_FFI_DCL_VOID;
			break;
		case YY_CHAR:
			if (dcl->flags & (CLIB_FFI_DCL_TYPE_SPECIFIERS-(CLIB_FFI_DCL_SIGNED|CLIB_FFI_DCL_UNSIGNED))) yy_error_sym("unexpected", sym);
			sym = get_sym();
			dcl->flags |= CLIB_FFI_DCL_CHAR;
			break;
		case YY_SHORT:
			if (dcl->flags & (CLIB_FFI_DCL_TYPE_SPECIFIERS-(CLIB_FFI_DCL_SIGNED|CLIB_FFI_DCL_UNSIGNED|CLIB_FFI_DCL_INT))) yy_error_sym("unexpected", sym);
			sym = get_sym();
			dcl->flags |= CLIB_FFI_DCL_SHORT;
			break;
		case YY_INT:
			if (dcl->flags & (CLIB_FFI_DCL_TYPE_SPECIFIERS-(CLIB_FFI_DCL_SIGNED|CLIB_FFI_DCL_UNSIGNED|CLIB_FFI_DCL_SHORT|CLIB_FFI_DCL_LONG|CLIB_FFI_DCL_LONG_LONG))) yy_error_sym("unexpected", sym);
			sym = get_sym();
			dcl->flags |= CLIB_FFI_DCL_INT;
			break;
		case YY_LONG:
			if (dcl->flags & CLIB_FFI_DCL_LONG) {
				if (dcl->flags & (CLIB_FFI_DCL_TYPE_SPECIFIERS-(CLIB_FFI_DCL_LONG|CLIB_FFI_DCL_SIGNED|CLIB_FFI_DCL_UNSIGNED|CLIB_FFI_DCL_INT))) yy_error_sym("unexpected", sym);
				dcl->flags |= CLIB_FFI_DCL_LONG_LONG;
			} else {
				if (dcl->flags & (CLIB_FFI_DCL_TYPE_SPECIFIERS-(CLIB_FFI_DCL_LONG|CLIB_FFI_DCL_SIGNED|CLIB_FFI_DCL_UNSIGNED|CLIB_FFI_DCL_INT|CLIB_FFI_DCL_DOUBLE|CLIB_FFI_DCL_COMPLEX))) yy_error_sym("unexpected", sym);
				dcl->flags |= CLIB_FFI_DCL_LONG;
			}
			sym = get_sym();
			break;
		case YY_FLOAT:
			if (dcl->flags & (CLIB_FFI_DCL_TYPE_SPECIFIERS-(CLIB_FFI_DCL_COMPLEX))) yy_error_sym("unexpected", sym);
			sym = get_sym();
			dcl->flags |= CLIB_FFI_DCL_FLOAT;
			break;
		case YY_DOUBLE:
			if (dcl->flags & (CLIB_FFI_DCL_TYPE_SPECIFIERS-(CLIB_FFI_DCL_LONG|CLIB_FFI_DCL_COMPLEX))) yy_error_sym("unexpected", sym);
			sym = get_sym();
			dcl->flags |= CLIB_FFI_DCL_DOUBLE;
			break;
		case YY_SIGNED:
			if (dcl->flags & (CLIB_FFI_DCL_TYPE_SPECIFIERS-(CLIB_FFI_DCL_CHAR|CLIB_FFI_DCL_SHORT|CLIB_FFI_DCL_LONG|CLIB_FFI_DCL_LONG_LONG|CLIB_FFI_DCL_INT))) yy_error_sym("unexpected", sym);
			sym = get_sym();
			dcl->flags |= CLIB_FFI_DCL_SIGNED;
			break;
		case YY_UNSIGNED:
			if (dcl->flags & (CLIB_FFI_DCL_TYPE_SPECIFIERS-(CLIB_FFI_DCL_CHAR|CLIB_FFI_DCL_SHORT|CLIB_FFI_DCL_LONG|CLIB_FFI_DCL_LONG_LONG|CLIB_FFI_DCL_INT))) yy_error_sym("unexpected", sym);
			sym = get_sym();
			dcl->flags |= CLIB_FFI_DCL_UNSIGNED;
			break;
		case YY__BOOL:
			if (dcl->flags & CLIB_FFI_DCL_TYPE_SPECIFIERS) yy_error_sym("unexpected", sym);
			sym = get_sym();
			dcl->flags |= CLIB_FFI_DCL_BOOL;
			break;
		case YY__COMPLEX:
		case YY_COMPLEX:
		case YY___COMPLEX:
		case YY___COMPLEX__:
			if (dcl->flags & (CLIB_FFI_DCL_TYPE_SPECIFIERS-(CLIB_FFI_DCL_FLOAT|CLIB_FFI_DCL_DOUBLE|CLIB_FFI_DCL_LONG))) yy_error_sym("unexpected", sym);
			sym = get_sym();
			dcl->flags |= CLIB_FFI_DCL_COMPLEX;
			break;
		case YY_STRUCT:
		case YY_UNION:
			if (dcl->flags & CLIB_FFI_DCL_TYPE_SPECIFIERS) yy_error_sym("unexpected", sym);
			sym = parse_struct_or_union_specifier(vm, sym, dcl);
			break;
		case YY_ENUM:
			if (dcl->flags & CLIB_FFI_DCL_TYPE_SPECIFIERS) yy_error_sym("unexpected", sym);
			sym = parse_enum_specifier(vm, sym, dcl);
			break;
		case YY_ID:
			if (dcl->flags & CLIB_FFI_DCL_TYPE_SPECIFIERS) yy_error_sym("unexpected", sym);
			/*redeclaration of '%.*s' ??? */
			...
			clib_ffi_resolve_typedef(name, name_len, dcl);
			break;
		default:
			yy_error_sym("unexpected", sym);
	}
...
static int parse_struct_or_union_specifier(b_vm *vm, int sym, clib_ffi_dcl *dcl) {
	if (sym == YY_STRUCT) {
		sym = get_sym();
		dcl->flags |= CLIB_FFI_DCL_STRUCT;
	} else if (sym == YY_UNION) {
		sym = get_sym();
		dcl->flags |= CLIB_FFI_DCL_UNION;
	} else {
		yy_error_sym("unexpected", sym);
	}
	if (YY_IN_SET(sym, (YY___ATTRIBUTE,YY___ATTRIBUTE__,YY___DECLSPEC,YY___CDECL,YY___STDCALL,YY___FASTCALL,YY___THISCALL,YY___VECTORCALL), "\000\000\000\000\000\000\360\017\000\000\000\000\000")) {
	...
	if (sym == YY_ID) {
		...
		size_t name_len;
		sym = parse_ID(sym, &name, &name_len);
		clib_ffi_declare_tag(name, name_len, dcl, 1);
		if (sym == YY__LBRACE) {
			sym = parse_struct_contents(vm, sym, dcl);
			clib_ffi_declare_tag(name, name_len, dcl, 0);
		}
...
static int parse_struct_contents(b_vm *vm, int sym, clib_ffi_dcl *dcl) {
	...
	sym = get_sym();
	if (YY_IN_SET(sym, (YY___EXTENSION__,YY_VOID,YY_CHAR,YY_SHORT,YY_INT,YY_LONG,YY_FLOAT,YY_DOUBLE,YY_SIGNED,YY_UNSIGNED,YY__BOOL,YY__COMPLEX,YY_COMPLEX,YY___COMPLEX,YY___COMPLEX__,YY_STRUCT,YY_UNION,YY_ENUM,YY_ID,YY_CONST,YY___CONST,YY___CONST__,YY_RESTRICT,YY___RESTRICT,YY___RESTRICT__,YY_VOLATILE,YY___VOLATILE,YY___VOLATILE__,YY__ATOMIC,YY___ATTRIBUTE,YY___ATTRIBUTE__,YY___DECLSPEC,YY___CDECL,YY___STDCALL,YY___FASTCALL,YY___THISCALL,YY___VECTORCALL), "\002\000\376\377\377\107\360\017\000\000\000\002\000")) {
		sym = parse_struct_declaration(vm, sym, dcl);
		while (1) {
			save_pos  = yy_pos;
			save_text = yy_text;
			save_line = yy_line;
...
_yy_state_2:
	...
	clib_ffi_adjust_struct_size(dcl);
	return sym;
}

static int parse_struct_declaration(b_vm *vm, int sym, clib_ffi_dcl *struct_dcl) {
	clib_ffi_dcl common_field_dcl = CLIB_FFI_ATTR_INIT;
	sym = parse_specifier_qualifier_list(vm, sym, &common_field_dcl);
	if (sym == YY__SEMICOLON || sym == YY__RBRACE) {
		clib_ffi_add_anonymous_field(struct_dcl, &common_field_dcl);
	} else if (sym == YY__STAR || sym == YY_ID || sym == YY__LPAREN || sym == YY__COLON) {
		sym = parse_struct_declarator(vm, sym, struct_dcl, &common_field_dcl);
		while (sym == YY__COMMA) {
			sym = get_sym();
			clib_ffi_dcl field_dcl = common_field_dcl;
			if (YY_IN_SET(sym, (YY___ATTRIBUTE,YY___ATTRIBUTE__,YY___DECLSPEC,YY___CDECL,YY___STDCALL,YY___FASTCALL,YY___THISCALL,YY___VECTORCALL), "\000\000\000\000\000\000\360\017\000\000\000\000\000")) {
				sym = parse_attributes(vm, sym, &field_dcl);
			}
			sym = parse_struct_declarator(vm, sym, struct_dcl, &field_dcl);
		}
	} else {
		yy_error_sym("unexpected", sym);
	}
...
static int parse_struct_declarator(b_vm *vm, int sym, clib_ffi_dcl *struct_dcl, clib_ffi_dcl *field_dcl) {
	...
	clib_ffi_val bits;
	if (sym == YY__STAR || sym == YY_ID || sym == YY__LPAREN) {
		sym = parse_declarator(vm, sym, field_dcl, &name, &name_len);
		if (sym == YY__COLON) {
			sym = get_sym();
			sym = parse_constant_expression(vm, sym, &bits);
			if (YY_IN_SET(sym, (YY___ATTRIBUTE,YY___ATTRIBUTE__,YY___DECLSPEC,YY___CDECL,YY___STDCALL,YY___FASTCALL,YY___THISCALL,YY___VECTORCALL), "\000\000\000\000\000\000\360\017\000\000\000\000\000")) {
				sym = parse_attributes(vm, sym, field_dcl);
			}
			clib_ffi_add_bit_field(struct_dcl, name, name_len, field_dcl, &bits);
			...
			clib_ffi_add_field(struct_dcl, name, name_len, field_dcl);
		} else {
			yy_error_sym("unexpected", sym);
		}
		...
		sym = get_sym();
		sym = parse_constant_expression(vm, sym, &bits);
		clib_ffi_add_bit_field(struct_dcl, NULL, 0, field_dcl, &bits);
	} else {
		yy_error_sym("unexpected", sym);
	}
	return sym;
...
static int parse_enum_specifier(b_vm *vm, int sym, clib_ffi_dcl *dcl) {
	...
	if (sym == YY_ID) {
		...
		if (sym == YY__LBRACE) {
			clib_ffi_declare_tag(name, name_len, dcl, 0);
			sym = get_sym();
			sym = parse_enumerator_list(vm, sym, dcl);
			if (sym != YY__RBRACE) {
				yy_error_sym("'}' expected, got", sym);
			}
			sym = get_sym();
...
static int parse_enumerator_list(b_vm *vm, int sym, clib_ffi_dcl *enum_dcl) {
	...
	sym = parse_enumerator(vm, sym, enum_dcl, &min, &max, &last);
	while (1) {
		save_pos  = yy_pos;
		save_text = yy_text;
		save_line = yy_line;
...
static int parse_enumerator(b_vm *vm, int sym, clib_ffi_dcl *enum_dcl, int64_t *min, int64_t *max, int64_t *last) {
	const char *name;
	size_t name_len;
	clib_ffi_val val = {.kind = CLIB_FFI_VAL_EMPTY};
	sym = parse_ID(sym, &name, &name_len);
	if (sym == YY__EQUAL) {
		sym = get_sym();
		sym = parse_constant_expression(vm, sym, &val);
	}
	clib_ffi_add_enum_val(enum_dcl, name, name_len, &val, min, max, last);
	return sym;
}

static int parse_declarator(b_vm *vm, int sym, clib_ffi_dcl *dcl, const char **name, size_t *name_len) {
	clib_ffi_dcl nested_dcl = {CLIB_FFI_DCL_CHAR, 0, 0, 0, NULL};
	bool nested = 0;
	if (sym == YY__STAR) {
		sym = parse_pointer(vm, sym, dcl);
	}
	if (sym == YY_ID) {
		sym = parse_ID(sym, name, name_len);
		...
		sym = get_sym();
		if (YY_IN_SET(sym, (YY___ATTRIBUTE,YY___ATTRIBUTE__,YY___DECLSPEC,YY___CDECL,YY___STDCALL,YY___FASTCALL,YY___THISCALL,YY___VECTORCALL), "\000\000\000\000\000\000\360\017\000\000\000\000\000")) {
			sym = parse_attributes(vm, sym, &nested_dcl);
		}
		sym = parse_declarator(vm, sym, &nested_dcl, name, name_len);
		if (sym != YY__RPAREN) {
			yy_error_sym("')' expected, got", sym);
		}
		sym = get_sym();
	...
	if (sym == YY__LBRACK || sym == YY__LPAREN) {
		sym = parse_array_or_function_declarators(vm, sym, dcl, &nested_dcl);
	}
	if (nested) clib_ffi_nested_declaration(dcl, &nested_dcl);
	return sym;
}
...
static int parse_abstract_declarator(b_vm *vm, int sym, clib_ffi_dcl *dcl) {
	...
	if ((sym == YY__LPAREN) && synpred_2(sym)) {
		...
		sym = parse_abstract_declarator(vm, sym, &nested_dcl);
		if (sym != YY__RPAREN) {
			yy_error_sym("')' expected, got", sym);
		}
		sym = get_sym();
...
static int parse_parameter_declarator(b_vm *vm, int sym, clib_ffi_dcl *dcl, const char **name, size_t *name_len) {
	...
	if ((sym == YY__LPAREN) && synpred_3(sym)) {
		...
		sym = parse_parameter_declarator(vm, sym, &nested_dcl, name, name_len);
		if (sym != YY__RPAREN) {
			yy_error_sym("')' expected, got", sym);
		}
		sym = get_sym();
...
static int parse_pointer(b_vm *vm, int sym, clib_ffi_dcl *dcl) {
	...
	do {
		sym = get_sym();
		clib_ffi_make_pointer_type(dcl);
		if (YY_IN_SET(sym, (YY_CONST,YY___CONST,YY___CONST__,YY_RESTRICT,YY___RESTRICT,YY___RESTRICT__,YY_VOLATILE,YY___VOLATILE,YY___VOLATILE__,YY__ATOMIC,YY___ATTRIBUTE,YY___ATTRIBUTE__,YY___DECLSPEC,YY___CDECL,YY___STDCALL,YY___FASTCALL,YY___THISCALL,YY___VECTORCALL), "\000\000\376\007\000\000\360\017\000\000\000\000\000")) {
			sym = parse_type_qualifier_list(vm, sym, dcl);
		}
	} while (sym == YY__STAR);
	return sym;
}
...
static int parse_array_or_function_declarators(b_vm *vm, int sym, clib_ffi_dcl *dcl, clib_ffi_dcl *nested_dcl) {
	...
	int alt105;
	int alt119;
	clib_ffi_dcl dummy = CLIB_FFI_ATTR_INIT;
	clib_ffi_val len = {.kind = CLIB_FFI_VAL_EMPTY};
	b_obj_dict *args = NULL;
	uint32_t attr = 0;
	if (sym == YY__LBRACK) {
		sym = get_sym();
		save_pos  = yy_pos;
...
_yy_state_105:
		...
		if (alt105 == 106) {
			sym = get_sym();
			if (YY_IN_SET(sym, (YY_CONST,YY___CONST,YY___CONST__,YY_RESTRICT,YY___RESTRICT,YY___RESTRICT__,YY_VOLATILE,YY___VOLATILE,YY___VOLATILE__,YY__ATOMIC,YY___ATTRIBUTE,YY___ATTRIBUTE__,YY___DECLSPEC,YY___CDECL,YY___STDCALL,YY___FASTCALL,YY___THISCALL,YY___VECTORCALL), "\000\000\376\007\000\000\360\017\000\000\000\000\000")) {
				sym = parse_type_qualifier_list(vm, sym, &dummy);
			}
			sym = parse_assignment_expression(vm, sym, &len);
		} else if (alt105 == 109) {
			sym = parse_type_qualifier_list(vm, sym, &dummy);
			save_pos  = yy_pos;
			save_text = yy_text;
...
_yy_state_109:
			...
			if (alt109 == 110) {
				...
				attr |= CLIB_FFI_ATTR_INCOMPLETE_ARRAY;
			} else if (alt109 == 112) {
				sym = get_sym();
				attr |= CLIB_FFI_ATTR_VLA;
			} else if (alt109 == 113) {
				sym = parse_assignment_expression(vm, sym, &len);
			} else {
				yy_error_sym("unexpected", sym);
		...
		dcl->attr |= attr;
		clib_ffi_make_array_type(dcl, &len);
	} else if (sym == YY__LPAREN) {
		sym = get_sym();
		if (YY_IN_SET(sym, (YY___EXTENSION__,YY_VOID,YY_CHAR,YY_SHORT,YY_INT,YY_LONG,YY_FLOAT,YY_DOUBLE,YY_SIGNED,YY_UNSIGNED,YY__BOOL,YY__COMPLEX,YY_COMPLEX,YY___COMPLEX,YY___COMPLEX__,YY_STRUCT,YY_UNION,YY_ENUM,YY_ID,YY_CONST,YY___CONST,YY___CONST__,YY_RESTRICT,YY___RESTRICT,YY___RESTRICT__,YY_VOLATILE,YY___VOLATILE,YY___VOLATILE__,YY__ATOMIC,YY___ATTRIBUTE,YY___ATTRIBUTE__,YY___DECLSPEC,YY___CDECL,YY___STDCALL,YY___FASTCALL,YY___THISCALL,YY___VECTORCALL,YY__POINT_POINT_POINT), "\002\000\376\377\377\107\370\017\000\000\000\002\000")) {
			if (YY_IN_SET(sym, (YY___EXTENSION__,YY_VOID,YY_CHAR,YY_SHORT,YY_INT,YY_LONG,YY_FLOAT,YY_DOUBLE,YY_SIGNED,YY_UNSIGNED,YY__BOOL,YY__COMPLEX,YY_COMPLEX,YY___COMPLEX,YY___COMPLEX__,YY_STRUCT,YY_UNION,YY_ENUM,YY_ID,YY_CONST,YY___CONST,YY___CONST__,YY_RESTRICT,YY___RESTRICT,YY___RESTRICT__,YY_VOLATILE,YY___VOLATILE,YY___VOLATILE__,YY__ATOMIC,YY___ATTRIBUTE,YY___ATTRIBUTE__,YY___DECLSPEC,YY___CDECL,YY___STDCALL,YY___FASTCALL,YY___THISCALL,YY___VECTORCALL), "\002\000\376\377\377\107\360\017\000\000\000\002\000")) {
				sym = parse_parameter_declaration(vm, sym, &args);
				while (1) {
					save_pos  = yy_pos;
					save_text = yy_text;
					save_line = yy_line;
...
_yy_state_119:
		...
		dcl->attr |= attr;
		clib_ffi_make_func_type(dcl, args, nested_dcl);
	} else {
		yy_error_sym("unexpected", sym);
	}
	return sym;
...
static int parse_parameter_declaration(b_vm *vm, int sym, b_obj_dict **args) {
	...
	FFI_G(allow_vla) = 1;
	clib_ffi_dcl param_dcl = CLIB_FFI_ATTR_INIT;
	sym = parse_specifier_qualifier_list(vm, sym, &param_dcl);
	sym = parse_parameter_declarator(vm, sym, &param_dcl, &name, &name_len);
	clib_ffi_add_arg(args, name, name_len, &param_dcl);
	FFI_G(allow_vla) = old_allow_vla;
	return sym;
}

static int parse_type_name(b_vm *vm, int sym, clib_ffi_dcl *dcl) {
	sym = parse_specifier_qualifier_list(vm, sym, dcl);
	sym = parse_abstract_declarator(vm, sym, dcl);
	return sym;
}
		...
		switch (sym) {
			...
			case YY___DECLSPEC:
				...
				do {
					...
					if (sym == YY__LPAREN) {
						sym = get_sym();
						sym = parse_assignment_expression(vm, sym, &val);
						clib_ffi_add_msvc_attribute_value(dcl, name, name_len, &val);
						if (sym != YY__RPAREN) {
							yy_error_sym("')' expected, got", sym);
						}
						sym = get_sym();
	...
	if (sym == YY_ID || sym == YY_CONST || sym == YY___CONST || sym == YY___CONST__) {
		if (sym == YY_ID) {
			...
			if (sym == YY__COMMA || sym == YY__RPAREN) {
				clib_ffi_add_attribute(dcl, name, name_len);
			} else if (sym == YY__LPAREN) {
				sym = get_sym();
				orig_attribute_parsing = FFI_G(attribute_parsing);
				FFI_G(attribute_parsing) = 1;
				sym = parse_assignment_expression(vm, sym, &val);
				clib_ffi_add_attribute_value(dcl, name, name_len, 0, &val);
				n = 0;
				while (sym == YY__COMMA) {
					sym = get_sym();
					sym = parse_assignment_expression(vm, sym, &val);
					clib_ffi_add_attribute_value(dcl, name, name_len, ++n, &val);
				}
...
static int parse_initializer(b_vm *vm, int sym) {
	...
	if (YY_IN_SET(sym, (YY__LPAREN,YY_ID,YY_OCTNUMBER,YY_DECNUMBER,YY_HEXNUMBER,YY_FLOATNUMBER,YY_STRING,YY_CHARACTER,YY__PLUS_PLUS,YY__MINUS_MINUS,YY__AND,YY__STAR,YY__PLUS,YY__MINUS,YY__TILDE,YY__BANG,YY_SIZEOF,YY__ALIGNOF,YY___ALIGNOF,YY___ALIGNOF__), "\010\000\000\000\000\000\001\000\004\030\377\376\000")) {
		sym = parse_assignment_expression(vm, sym, &dummy);
	} else if (sym == YY__LBRACE) {
		sym = get_sym();
		if (sym == YY__LBRACK || sym == YY__POINT) {
			sym = parse_designation(vm, sym);
		}
		sym = parse_initializer(vm, sym);
		while (1) {
			save_pos  = yy_pos;
...
static int parse_designation(b_vm *vm, int sym) {
	...
	do {
		if (sym == YY__LBRACK) {
			sym = get_sym();
			sym = parse_constant_expression(vm, sym, &dummy);
			if (sym != YY__RBRACK) {
				yy_error_sym("']' expected, got", sym);
			}
			sym = get_sym();
...
static int parse_assignment_expression(b_vm *vm, int sym, clib_ffi_val *val) {
	sym = parse_conditional_expression(vm, sym, val);
	return sym;
}
...
static int parse_conditional_expression(b_vm *vm, int sym, clib_ffi_val *val) {
	clib_ffi_val op2, op3;
	sym = parse_logical_or_expression(vm, sym, val);
	if (sym == YY__QUERY) {
		sym = get_sym();
		sym = parse_expression(vm, sym, &op2);
		if (sym != YY__COLON) {
			yy_error_sym("':' expected, got", sym);
		}
		sym = get_sym();
		sym = parse_conditional_expression(vm, sym, &op3);
		clib_ffi_expr_conditional(val, &op2, &op3);
	}
	return sym;
}
...
static int parse_logical_or_expression(b_vm *vm, int sym, clib_ffi_val *val) {
	clib_ffi_val op2;
	sym = parse_logical_and_expression(vm, sym, val);
	while (sym == YY__BAR_BAR) {
		sym = get_sym();
		sym = parse_logical_and_expression(vm, sym, &op2);
		clib_ffi_expr_bool_or(val, &op2);
	}
	return sym;
}
...
static int parse_logical_and_expression(b_vm *vm, int sym, clib_ffi_val *val) {
	clib_ffi_val op2;
	sym = parse_inclusive_or_expression(vm, sym, val);
	while (sym == YY__AND_AND) {
		sym = get_sym();
		sym = parse_inclusive_or_expression(vm, sym, &op2);
		clib_ffi_expr_bool_and(val, &op2);
	}
	return sym;
}
...
static int parse_inclusive_or_expression(b_vm *vm, int sym, clib_ffi_val *val) {
	clib_ffi_val op2;
	sym = parse_exclusive_or_expression(vm, sym, val);
	while (sym == YY__BAR) {
		sym = get_sym();
		sym = parse_exclusive_or_expression(vm, sym, &op2);
		clib_ffi_expr_bw_or(val, &op2);
	}
	return sym;
}
...
static int parse_exclusive_or_expression(b_vm *vm, int sym, clib_ffi_val *val) {
	clib_ffi_val op2;
	sym = parse_and_expression(vm, sym, val);
	while (sym == YY__UPARROW) {
		sym = get_sym();
		sym = parse_and_expression(vm, sym, &op2);
		clib_ffi_expr_bw_xor(val, &op2);
	}
	return sym;
}
...
static int parse_and_expression(b_vm *vm, int sym, clib_ffi_val *val) {
	clib_ffi_val op2;
	sym = parse_equality_expression(vm, sym, val);
	while (sym == YY__AND) {
		sym = get_sym();
		sym = parse_equality_expression(vm, sym, &op2);
		clib_ffi_expr_bw_and(val, &op2);
	}
	return sym;
}
...
static int parse_equality_expression(b_vm *vm, int sym, clib_ffi_val *val) {
	clib_ffi_val op2;
	sym = parse_relational_expression(vm, sym, val);
	while (sym == YY__EQUAL_EQUAL || sym == YY__BANG_EQUAL) {
		if (sym == YY__EQUAL_EQUAL) {
			sym = get_sym();
			sym = parse_relational_expression(vm, sym, &op2);
			clib_ffi_expr_is_equal(val, &op2);
		} else {
			sym = get_sym();
			sym = parse_relational_expression(vm, sym, &op2);
			clib_ffi_expr_is_not_equal(val, &op2);
		}
	}
	return sym;
}
...
static int parse_relational_expression(b_vm *vm, int sym, clib_ffi_val *val) {
	clib_ffi_val op2;
	sym = parse_shift_expression(vm, sym, val);
	while (sym == YY__LESS || sym == YY__GREATER || sym == YY__LESS_EQUAL || sym == YY__GREATER_EQUAL) {
		if (sym == YY__LESS) {
			sym = get_sym();
			sym = parse_shift_expression(vm, sym, &op2);
			clib_ffi_expr_is_less(val, &op2);
		} else if (sym == YY__GREATER) {
			sym = get_sym();
			sym = parse_shift_expression(vm, sym, &op2);
			clib_ffi_expr_is_greater(val, &op2);
		} else if (sym == YY__LESS_EQUAL) {
			sym = get_sym();
			sym = parse_shift_expression(vm, sym, &op2);
			clib_ffi_expr_is_less_or_equal(val, &op2);
		} else {
			sym = get_sym();
			sym = parse_shift_expression(vm, sym, &op2);
			clib_ffi_expr_is_greater_or_equal(val, &op2);
		}
	}
	return sym;
}
...
static int parse_shift_expression(b_vm *vm, int sym, clib_ffi_val *val) {
	clib_ffi_val op2;
	sym = parse_additive_expression(vm, sym, val);
	while (sym == YY__LESS_LESS || sym == YY__GREATER_GREATER) {
		if (sym == YY__LESS_LESS) {
			sym = get_sym();
			sym = parse_additive_expression(vm, sym, &op2);
			clib_ffi_expr_shift_left(val, &op2);
		} else {
			sym = get_sym();
			sym = parse_additive_expression(vm, sym, &op2);
			clib_ffi_expr_shift_right(val, &op2);
		}
	}
	return sym;
}
...
static int parse_additive_expression(b_vm *vm, int sym, clib_ffi_val *val) {
	clib_ffi_val op2;
	sym = parse_multiplicative_expression(vm, sym, val);
	while (sym == YY__PLUS || sym == YY__MINUS) {
		if (sym == YY__PLUS) {
			sym = get_sym();
			sym = parse_multiplicative_expression(vm, sym, &op2);
			clib_ffi_expr_add(val, &op2);
		} else {
			sym = get_sym();
			sym = parse_multiplicative_expression(vm, sym, &op2);
			clib_ffi_expr_sub(val, &op2);
		}
	}
	return sym;
}
...
static int parse_multiplicative_expression(b_vm *vm, int sym, clib_ffi_val *val) {
	clib_ffi_val op2;
	sym = parse_cast_expression(vm, sym, val);
	while (sym == YY__STAR || sym == YY__SLASH || sym == YY__PERCENT) {
		if (sym == YY__STAR) {
			sym = get_sym();
			sym = parse_cast_expression(vm, sym, &op2);
			clib_ffi_expr_mul(val, &op2);
		} else if (sym == YY__SLASH) {
			sym = get_sym();
			sym = parse_cast_expression(vm, sym, &op2);
			clib_ffi_expr_div(val, &op2);
		} else {
			sym = get_sym();
			sym = parse_cast_expression(vm, sym, &op2);
			clib_ffi_expr_mod(val, &op2);
		}
	}
	return sym;
}
...
static int parse_cast_expression(b_vm *vm, int sym, clib_ffi_val *val) {
	...
	if ((sym == YY__LPAREN) && synpred_4(sym)) {
		sym = get_sym();
		sym = parse_type_name(vm, sym, &dcl);
		if (sym != YY__RPAREN) {
			yy_error_sym("')' expected, got", sym);
		}
		sym = get_sym();
	...
	sym = parse_unary_expression(vm, sym, val);
	if (do_cast) clib_ffi_expr_cast(val, &dcl);
	return sym;
}
...
static int parse_unary_expression(b_vm *vm, int sym, clib_ffi_val *val) {
	...
	switch (sym) {
		case YY_ID:
			sym = parse_ID(sym, &name, &name_len);
			clib_ffi_resolve_const(name, name_len, val);
		...
		case YY__LPAREN:
			sym = get_sym();
			sym = parse_expression(vm, sym, val);
			if (sym != YY__RPAREN) {
				yy_error_sym("')' expected, got", sym);
			}
			sym = get_sym();
		...
		case YY__PLUS:
			sym = get_sym();
			sym = parse_cast_expression(vm, sym, val);
			clib_ffi_expr_plus(val);
			break;
		case YY__MINUS:
			sym = get_sym();
			sym = parse_cast_expression(vm, sym, val);
			clib_ffi_expr_neg(val);
			break;
		case YY__TILDE:
			sym = get_sym();
			sym = parse_cast_expression(vm, sym, val);
			clib_ffi_expr_bw_not(val);
			break;
		case YY__BANG:
			sym = get_sym();
			sym = parse_cast_expression(vm, sym, val);
			clib_ffi_expr_bool_not(val);
			break;
		case YY_SIZEOF:
			sym = get_sym();
			if ((sym == YY__LPAREN) && synpred_5(sym)) {
				...
				sym = get_sym();
				clib_ffi_expr_sizeof_type(val, &dcl);
		...
		case YY__ALIGNOF:
			...
			sym = get_sym();
			clib_ffi_expr_alignof_type(val, &dcl);
			break;
		case YY___ALIGNOF:
		case YY___ALIGNOF__:
			sym = get_sym();
...
static int parse_OCTNUMBER(int sym, clib_ffi_val *val) {
	...
	clib_ffi_val_number(val, 8, (const char*)yy_text, yy_pos - yy_text);
	sym = get_sym();
	return sym;
}
...
static int parse_DECNUMBER(int sym, clib_ffi_val *val) {
	...
	clib_ffi_val_number(val, 10, (const char*)yy_text, yy_pos - yy_text);
	sym = get_sym();
	return sym;
}
...
static int parse_HEXNUMBER(int sym, clib_ffi_val *val) {
	...
	clib_ffi_val_number(val, 16, (const char*)yy_text + 2, yy_pos - yy_text - 2);
	sym = get_sym();
	return sym;
}
...
static int parse_FLOATNUMBER(int sym, clib_ffi_val *val) {
	...
	clib_ffi_val_float_number(val, (const char*)yy_text, yy_pos - yy_text);
	sym = get_sym();
	return sym;
}
...
static int parse_STRING(int sym, clib_ffi_val *val) {
	...
	clib_ffi_val_string(val, (const char*)yy_text, yy_pos - yy_text);
	sym = get_sym();
	return sym;
}
...
static int parse_CHARACTER(int sym, clib_ffi_val *val) {
	...
	clib_ffi_val_character(val, (const char*)yy_text, yy_pos - yy_text);
	sym = get_sym();
	return sym;
}

static void parse(b_vm *vm) {
	int sym;

	yy_pos = yy_text = yy_buf;
	yy_line = 1;
	sym = parse_declarations(vm, get_sym());
	if (sym != YY_EOF) {
...
bool clib_ffi_parse_type(b_vm *vm, const char *str, size_t len, clib_ffi_dcl *dcl) {
	...
	if (SETJMP(FFI_G(bailout))==0) {
		...
		yy_end = yy_buf + len;
		yy_line = 1;
		sym = parse_type_name(vm, get_sym(), dcl);
		if (sym != YY_EOF) {
			yy_error_sym("<EOF> expected, got", sym);
		}
		clib_ffi_validate_type_name(dcl);
		return true;
	} else {
		return false;
	};
...
static void yy_error(const char *msg) {
	clib_ffi_parser_error("%s at line %d", msg, yy_line);
}

static void yy_error_sym(const char *msg, int sym) {
	clib_ffi_parser_error("%s '%s' at line %d", msg, sym_name[sym], yy_line);
}
