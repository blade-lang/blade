...
struct CURLInfoTypeMap {
  int type;
    ...
    [CURLINFO_EFFECTIVE_METHOD] = { CURLINFO_STRING  },
    [CURLINFO_PROXY_ERROR] = { CURLINFO_LONG  },
    [CURLINFO_REFERER] = { CURLINFO_STRING  }
};
...
DEFINE_CURL_CONSTANT(CURLOPT_MAIL_RCPT_ALLLOWFAILS)
DEFINE_CURL_CONSTANT(CURLOPT_SSLCERT_BLOB)
DEFINE_CURL_CONSTANT(CURLOPT_SSLKEY_BLOB)
DEFINE_CURL_CONSTANT(CURLOPT_PROXY_SSLCERT_BLOB)
DEFINE_CURL_CONSTANT(CURLOPT_PROXY_SSLKEY_BLOB)
DEFINE_CURL_CONSTANT(CURLOPT_ISSUERCERT_BLOB)
DEFINE_CURL_CONSTANT(CURLOPT_PROXY_ISSUERCERT)
DEFINE_CURL_CONSTANT(CURLOPT_PROXY_ISSUERCERT_BLOB)
DEFINE_CURL_CONSTANT(CURLOPT_SSL_EC_CURVES)
DEFINE_CURL_CONSTANT(CURLOPT_HSTS_CTRL)
DEFINE_CURL_CONSTANT(CURLOPT_HSTS)
DEFINE_CURL_CONSTANT(CURLOPT_AWS_SIGV4)
DEFINE_CURL_CONSTANT(CURLOPT_DOH_SSL_VERIFYPEER)
DEFINE_CURL_CONSTANT(CURLOPT_DOH_SSL_VERIFYHOST)
DEFINE_CURL_CONSTANT(CURLOPT_DOH_SSL_VERIFYSTATUS)
DEFINE_CURL_CONSTANT(CURLOPT_CAINFO_BLOB)
DEFINE_CURL_CONSTANT(CURLOPT_PROXY_CAINFO_BLOB)
...
DEFINE_CURL_CONSTANT(CURLINFO_EFFECTIVE_METHOD)
DEFINE_CURL_CONSTANT(CURLINFO_PROXY_ERROR)
DEFINE_CURL_CONSTANT(CURLINFO_REFERER)
...
const char *get_error_message(int result) {
  switch(result) {
    ...
    case CURLE_QUIC_CONNECT_ERROR: return "QUIC connect error";
    case CURLE_SSL_CLIENTCERT: return "ssl client certificate error";
...
CREATE_MODULE_LOADER(curl) {
  ...
  static b_field_reg module_fields[] = {
      ...
      GET_CURL_CONSTANT(CURLOPT_MAIL_RCPT_ALLLOWFAILS),
      GET_CURL_CONSTANT(CURLOPT_SSLCERT_BLOB),
      GET_CURL_CONSTANT(CURLOPT_SSLKEY_BLOB),
      GET_CURL_CONSTANT(CURLOPT_PROXY_SSLCERT_BLOB),
      GET_CURL_CONSTANT(CURLOPT_PROXY_SSLKEY_BLOB),
      GET_CURL_CONSTANT(CURLOPT_ISSUERCERT_BLOB),
      GET_CURL_CONSTANT(CURLOPT_PROXY_ISSUERCERT),
      GET_CURL_CONSTANT(CURLOPT_PROXY_ISSUERCERT_BLOB),
      GET_CURL_CONSTANT(CURLOPT_SSL_EC_CURVES),
      GET_CURL_CONSTANT(CURLOPT_HSTS_CTRL),
      GET_CURL_CONSTANT(CURLOPT_HSTS),
      GET_CURL_CONSTANT(CURLOPT_AWS_SIGV4),
      GET_CURL_CONSTANT(CURLOPT_DOH_SSL_VERIFYPEER),
      GET_CURL_CONSTANT(CURLOPT_DOH_SSL_VERIFYHOST),
      GET_CURL_CONSTANT(CURLOPT_DOH_SSL_VERIFYSTATUS),
      GET_CURL_CONSTANT(CURLOPT_CAINFO_BLOB),
      GET_CURL_CONSTANT(CURLOPT_PROXY_CAINFO_BLOB),
      ...
      GET_CURL_CONSTANT(CURLINFO_EFFECTIVE_METHOD),
      GET_CURL_CONSTANT(CURLINFO_PROXY_ERROR),
      GET_CURL_CONSTANT(CURLINFO_REFERER),
