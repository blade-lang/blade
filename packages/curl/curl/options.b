...
class Option {
   ...
   * @static
    ...
    * @static
    */
   static var MAIL_RCPT_ALLLOWFAILS = _curl.CURLOPT_MAIL_RCPT_ALLLOWFAILS

   /**
    * the private SSL-certificate as a "blob" 
    * @static
    */
   static var SSLCERT_BLOB = _curl.CURLOPT_SSLCERT_BLOB

   /**
    * the private SSL-certificate key as a "blob" 
    * @static
    */
   static var SSLKEY_BLOB = _curl.CURLOPT_SSLKEY_BLOB

   /**
    * the private proxy SSL-certificate as a "blob" 
    * @static
    */
   static var PROXY_SSLCERT_BLOB = _curl.CURLOPT_PROXY_SSLCERT_BLOB

   /**
    * the private proxy SSL-certificate key as a "blob" 
    * @static
    */
   static var PROXY_SSLKEY_BLOB = _curl.CURLOPT_PROXY_SSLKEY_BLOB

   /**
    * the private issuer SSL-certificate as a "blob" 
    * @static
    */
   static var ISSUERCERT_BLOB = _curl.CURLOPT_ISSUERCERT_BLOB

   /**
    * Issuer certificate for proxy 
    * @static
    */
   static var PROXY_ISSUERCERT = _curl.CURLOPT_PROXY_ISSUERCERT

   /**
    * Issuer certificate for proxy as a "blob"
    * @static
    */
   static var PROXY_ISSUERCERT_BLOB = _curl.CURLOPT_PROXY_ISSUERCERT_BLOB
    ...
    * @static
    */
   static var SSL_EC_CURVES = _curl.CURLOPT_SSL_EC_CURVES

   /**
    * HSTS bitmask 
    * @static
    */
   static var HSTS_CTRL = _curl.CURLOPT_HSTS_CTRL

   /**
    * HSTS file name 
    * @static
    */
   static var HSTS = _curl.CURLOPT_HSTS

   /**
    * Parameters for V4 signature 
    * @static
    */
   static var AWS_SIGV4 = _curl.CURLOPT_AWS_SIGV4

   /**
    * Same as CURLOPT_SSL_VERIFYPEER but for DOH (DNS-over-HTTPS) servers. 
    * @static
    */
   static var DOH_SSL_VERIFYPEER = _curl.CURLOPT_DOH_SSL_VERIFYPEER

   /**
    * Same as CURLOPT_SSL_VERIFYHOST but for DOH (DNS-over-HTTPS) servers. 
    * @static
    */
   static var DOH_SSL_VERIFYHOST = _curl.CURLOPT_DOH_SSL_VERIFYHOST

   /**
    * Same as CURLOPT_SSL_VERIFYSTATUS but for DOH (DNS-over-HTTPS) servers. 
    * @static
    */
   static var DOH_SSL_VERIFYSTATUS = _curl.CURLOPT_DOH_SSL_VERIFYSTATUS
    ...
    * @static
    */
   static var CAINFO_BLOB = _curl.CURLOPT_CAINFO_BLOB
    ...
    * @static
    */
   static var PROXY_CAINFO_BLOB = _curl.CURLOPT_PROXY_CAINFO_BLOB
