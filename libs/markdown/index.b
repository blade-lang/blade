...
class Markdown {
  ...
  *        '</code></pre>'
  ...
  /**
   * The same as [[markdown.Markdown.enable]], but turn specified rules off.
   * 
  ...
  /**
   * The same as [[markdown.Markdown.parse]] but skip all block rules. It returns the
  ...
  /**
   * Similar to [[markdown.Markdown.render]] but for single paragraph content. Result
