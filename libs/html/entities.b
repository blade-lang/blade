...
# The html module doesn't export this by default so it needs to be 
# imported when needed even if you already have imported html.
...
for name, codepoint in name2codepoint {
